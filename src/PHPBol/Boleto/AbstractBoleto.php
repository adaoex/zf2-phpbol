...
class AbstractBoleto extends Data\AbstractData
{
     ...
     * @return string
     */
    public function renderDefault( $tpl = 'default' )
    {
        try {
            $class = 'PHPBol\Template\\' . $this->templateClasses[$tpl];
            $template = new $class();
     ...
     *
     * @param string $tpl nome do template
     * @return \PHPBol\Boleto\AbstractBoleto
     */
    public function render( $tpl = 'default' )
    {
        return $this->renderDefault( $tpl );
    }
